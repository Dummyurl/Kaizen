...
public class FoodChildCategoryAdapter extends CommonRecyclerAdapter<FoodSubcategory> {
    ...
    public FoodChildCategoryAdapter(Category category, FoodCategory foodCategory, String childId, ISetOnFoodChildClickListener iSetOnChildClickListener) {
