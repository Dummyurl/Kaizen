...
public class FoodSubcategoryAdapter extends CommonRecyclerAdapter<FoodCategory> {
    ...
    public FoodSubcategoryAdapter(Category category, String subId, String childId, ISetOnFoodChildClickListener iSetOnChildClickListener) {
    ...
    public RecyclerView.ViewHolder onCreateBasicItemViewHolder(ViewGroup parent, int viewType) {
        ...
        return new FoodSubcategoryViewHolder(itemView);
    }

    @Override
    public void onBindBasicItemView(RecyclerView.ViewHolder holder, int position) {
        FoodSubcategoryViewHolder foodSubcategoryViewHolder = (FoodSubcategoryViewHolder) holder;
        foodSubcategoryViewHolder.bindData(position);
    }

    private class FoodSubcategoryViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        private TextView tv_sub_category;
        private RecyclerView rv_child_category;

        private FoodSubcategoryViewHolder(View view) {
            super(view);
        ...
        private void showRecyclerView(FoodCategory foodCategory) {
            ...
            final FoodChildCategoryAdapter childCategoryAdapter = new FoodChildCategoryAdapter(category, foodCategory, childId, iSetOnChildClickListener);
