...
public class APIUrls {
    ...
    public static final String SENDENQUERY = BASE_URL + "index.php/api/sendenquiry";
    ...
    public static final String FOOD_ITEMS = BASE_URL + "index.php/api/getImageslistfood";
    ...
    public static final String SETTINGS = BASE_URL + "index.php/api/getSettings";
    ...
    public static final String DESCRIPTION_URL = BASE_URL + "index.php/api/getAddescription?description";
